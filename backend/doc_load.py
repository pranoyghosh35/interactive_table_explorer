...
def load_data(uploaded_file, **kwargs):
    ...
    try:
        ...
        # If uploaded_file does not have a 'name' attribute, handle it as a
        # string
        ...
        try:
            if ext in {"xls", "xlsx", "xlsm", "xlsb"}:
                ...
                excel_data = pd.read_excel(
                    uploaded_file, sheet_name=None, **kwargs)
            ...
            print(f"Error: {e}")
            print(
                "An unexpected keyword argument was passed. Please check the parameters and try again.")
            return None
